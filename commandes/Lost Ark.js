module.exports = async function (message) { 
      ...
      if (message.content === '!berserker') {  
            message.channel.send(`https://www.youtube.com/watch?v=hZ0AJdAdOSc`)}; 
      if (message.content === '!paladin') {  
            message.channel.send(`https://www.youtube.com/watch?v=xUnabf4SqG4`)}; 
      if (message.content === '!pistolancier') {  
