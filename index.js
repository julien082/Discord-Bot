...
Military : <https://escapefromtarkov-fr.gamepedia.com/Base_militaire>`)}; 
  ...
  if (message.content === '!scav') { 
    message.channel.send(`https://cdn.discordapp.com/attachments/776801862778093568/860476889650561034/EFT_Scav_Code_FR.png  ● La réputation chez Fence ne diminuera désormais pas si le joueur a tué un Scav qui a attaqué en premier.`)};   
